local UpgradeConfig = {
	...
	-- RARE GRASS
	GoldGrass1={Price=150,Requires="Grass3",GoldGrassChanceBonus=.01,Title="Gold Grass I",Description="Gold grass appears more often.",BonusText="Gold Chance: 2%"},
	...
	RainbowGrass1={Price=500,Requires="Grass5",RainbowGrassChanceBonus=.001,Title="Rainbow Grass I",Description="Rainbow grass appears more often.",BonusText="Rainbow Chance: 0.2%"},
	...
	InstantBreak1={Price=500,Requires="Coins3",InstantBreakChance=.05,Title="Instant Break I",Description="Chance to instantly destroy grass on hit.",BonusText="5% Instant Break"},
